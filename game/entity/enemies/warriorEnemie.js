class WarriorEnemie extends Enemie {

    constructor(x, y){
        super(x, y, Config.entityType.WARRIOR, Config.WARRIOR_HP, Config.WARRIOR_DM);

        this.drawing = new Image();
        this.drawing.src = "./images/warrior_enemie.png";
    }

    update(){
        var speed = 0;
        if(this.frost){ 
            speed = Config.WARRIOR_SP / 2;
            this.iceTime += 0.1;
